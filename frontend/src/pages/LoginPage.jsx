                ...
                <div className="p-8">
                  <div className="mb-8">
                    <p className="text-gray-600 text-center mb-6">
                      Sign in with your institutional account to get started.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <button
                      ...
                      disabled={isLoading}
                      className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:from-gray-400 disabled:to-gray-400 text-white font-bold py-3 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 disabled:hover:scale-100 flex items-center justify-center gap-3 shadow-lg"
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
